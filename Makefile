...
ADXL345_NET :  ${DEMO_PATH}Demo_ADXL345/ADXL345_net.c libiobb.a
	${cc} -o ADXL345 ${DEMO_PATH}Demo_ADXL345/ADXL345_net.c -L ${LIB_PATH} -liobb

L3G4200D : ${DEMO_PATH}Demo_L3G4200D/L3G4200D.c libiobb.a
	${cc} -o L3G4200D ${DEMO_PATH}Demo_L3G4200D/L3G4200D.c -L ${LIB_PATH} -liobb

SEVEN_SCAN : ${DEMO_PATH}Demo_SevenScan/SevenScan.c libiobb.a
	${cc} -o SevenScan ${DEMO_PATH}Demo_SevenScan/SevenScan.c  -L ${LIB_PATH} -liobb

SMOTOR : ${DEMO_PATH}Demo_ServoMotor/ServoMotor.c libiobb.a
	${cc} -o SMOTOR ${DEMO_PATH}Demo_ServoMotor/ServoMotor.c -L ${LIB_PATH} -liobb

LED_GPIO : ${DEMO_PATH}Demo_LED_GPIO/LED_GPIO.c libiobb.a
	${cc} -o LED_GPIO ${DEMO_PATH}Demo_LED_GPIO/LED_GPIO.c -L ${LIB_PATH} -liobb -pthread

DEBOUNCING : ${DEMO_PATH}Demo_Debouncing/Debouncing.c libiobb.a
	${cc} -o Debouncing ${DEMO_PATH}Demo_Debouncing/Debouncing.c -L ${LIB_PATH} -liobb

4x4keypad : ${DEMO_PATH}Demo_4x4keypad/4x4keypad.c libiobb.a
	${cc} -o 4x4keypad ${DEMO_PATH}Demo_4x4keypad/4x4keypad.c -L ${LIB_PATH} -liobb
...
ADC_VOICE : ${DEMO_PATH}Demo_ADC/ADC_voice.c libiobb.a
	${cc} -o ADC_VOICE ${DEMO_PATH}Demo_ADC/ADC_voice.c -L ${LIB_PATH} -liobb -lm -pthread -O3
...
GPIO_STATUS : ${TOOLKIT_PATH}Toolkit_GPIO_CLK_Status/GPIO_status.c libiobb.a
	${cc} -o GPIO_CLK_status ${TOOLKIT_PATH}Toolkit_GPIO_CLK_Status/GPIO_status.c  -L ${LIB_PATH} -liobb

EP_STATUS : ${TOOLKIT_PATH}Toolkit_EP_Status/EP_status.c libiobb.a
	${cc} -o EP_status ${TOOLKIT_PATH}Toolkit_EP_Status/EP_status.c -L ${LIB_PATH} -liobb
...
RA : ${LAB_PATH}Lab_Robot_Arm/Robot_Arm.c libiobb.a
	${cc} -o RA  ${LAB_PATH}Lab_Robot_Arm/Robot_Arm.c -L ${LIB_PATH} -liobb -lm
